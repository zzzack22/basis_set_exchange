...
def run_bse_cli():
    ...
    subp = subparsers.add_parser(
        'list-ref-formats', help='Output a list all available reference formats and descriptions')
    ...
    subp.add_argument('primary_basis', help='Name of the primary basis we want the auxiliary basis for').completer = cli_bsname_completer
    ...
    subp.add_argument('name', help='Name of the basis set to output').completer = cli_bsname_completer
    ...
    subp.add_argument('name', help='Name of the basis set to output the references for').completer = cli_bsname_completer
    subp.add_argument('fmt', help='Which format to output the references as').completer = cli_reffmt_completer
    ...
    subp.add_argument('name', help='Name of the basis set to output the info for').completer = cli_bsname_completer

    # get-notes subcommand
    subp = subparsers.add_parser('get-notes', help='Output the notes for a basis set')
    subp.add_argument('name', help='Name of the basis set to output the notes for').completer = cli_bsname_completer

    # get-family subcommand
    subp = subparsers.add_parser('get-family', help='Output the family of a basis set')
    subp.add_argument('name', help='Name of the basis set to output the family for').completer = cli_bsname_completer

    # get-versions subcommand
    subp = subparsers.add_parser('get-versions', help='Output a list all available versions of a basis set')
    subp.add_argument('name', help='Name of the basis set to list the versions of').completer = cli_bsname_completer
